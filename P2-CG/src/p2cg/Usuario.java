...
public class Usuario {
	 ...
	 * @throws Exception . lanÁa exceÁ„o para nome e id nulo/vazio
	 */
	public Usuario(String nome, String id) throws Exception {
		if (nome == null || nome.trim().equals(""))
			throw new ParametroVazioException("Nome do usu√°rio n√£o pode ser nulo ou vazio.");
		if (id == null || id.trim().equals(""))
			throw new ParametroVazioException("ID do usu√°rio n√£o pode ser nulo ou vazio.");
		this.nome = nome;
		this.id = id;
		categoria = new Noob();
		x2p = 0;
	...
	/**
	 * operaÁ„o de compra de jogo, adiciona na lista do usuario, diminui do seu dinheiro o preco do jogo menos o desconto
	 * e adiciona x2p no seu perfil
	 * 
	 * @param jogo . recebe o jogo j· criado
	 * @throws Exception . lanÁa exceÁ„o caso o usu·rio ja tenha o jogo ou caso n„o tenha dinheiro suficiente
	 */
	protected void compraJogo(Jogo jogo) throws Exception {
		...
		if (procuraJogo(jogo.getNome()) != null)
			throw new JogoException("O usu√°rio j√° tem esse jogo.");
		if (preco > dinheiro)
	 ...
	 * @param score . pontuaÁ„o feita na rodada
	 * @param zerou . booleano que diz se o usu·rio zerou o jogo (true) ou nao (false)
	 * @throws Exception . exceÁ„o lanÁada pelo mÈtodo chamado na classe Jogo
	 */
	...
	public String toString() {
		...
		stringCompleta += "Total de pre√ßo dos jogos: R$ " + precoTotal() + NL + NL
				+ "--------------------------------------------" + NL + NL;
